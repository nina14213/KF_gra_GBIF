...
export default function StartScreen({
    ...
    return (
        <div className="min-h-screen p-4 md:p-8 bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-100 dark:from-slate-900 dark:via-indigo-950 dark:to-purple-950">
